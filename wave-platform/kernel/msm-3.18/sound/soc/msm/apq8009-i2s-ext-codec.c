...
#define NO_WCD9236_REC
#ifndef NO_WCD9236_REC
...
static struct snd_soc_dai_link apq8009_9326_dai[] = {
...
#endif
	{
		...
		.platform_name = "msm-pcm-routing",
		.codec_name     = "tas5731.4-001a",
		.codec_dai_name = "tas5731-hifi",
		.no_pcm = 1,
		.dpcm_playback = 1,
		.be_id = MSM_BACKEND_DAI_PRI_MI2S_RX,
#ifdef NO_WCD9236_REC
		.init = &msm_audrx_init_wcd,
#endif
...
static int apq8009_asoc_machine_probe(struct platform_device *pdev)
{
	...
	// [NUA] removed by Will, disable wsa init since dtsi is already removed.
