...
#define BQ2477X_CHARGE_VOLTAGE_LSB		0x0C
#define BQ2477X_CHARGE_VOLTAGE_MSB		0x0D
...
#define BQ2477X_CHARGE_OPTION_POR_MSB		0xE1
...
extern void bq2477x_update_current(int curr);
extern void bq2477x_update_voltage(int volt);
