...
int lp55xx_write_block(struct lp55xx_chip *chip, u8 reg, u8 len, const u8 *val)
{
	return i2c_smbus_write_i2c_block_data(chip->cl, reg, len, val);
}
EXPORT_SYMBOL_GPL(lp55xx_write_block);
...
int lp552312_init_device(struct lp55xx_chip *chip)
{
...
EXPORT_SYMBOL_GPL(lp552312_init_device);
