...
extern int lp55xx_write_block(struct lp55xx_chip *chip, u8 reg, u8 len, const u8 *val);
...
extern int lp552312_init_device(struct lp55xx_chip *chip);
...
/* for LED animation */
extern void lp552308_animation(int index, int mode);
extern void lp552309_animation(int index, int mode);
extern void lp552310_animation(int index, int mode);
