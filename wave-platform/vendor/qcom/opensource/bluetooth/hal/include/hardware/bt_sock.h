...
typedef void (*spp_received_data_callback)(char *addr, char* rcv_data, int len);
typedef void (*spp_device_connect_callback)(char *addr, int onoff);

typedef struct {
    /** set to sizeof(bt_callbacks_t) */
    size_t size;
    spp_received_data_callback spp_rcv_data_cb;
    spp_device_connect_callback spp_dev_connnect_cb;
} spp_callbacks_t;
...
typedef struct {
    ...
    int (*set_callbacks)(spp_callbacks_t *callbacks);
    /**
    ...
    int (*send_data)(char *addr, char *data, int len);
} btsock_interface_t;
